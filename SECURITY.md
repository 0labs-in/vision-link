...
If you find a security vulnerability in 0labs-vision, please **do not open a public issue**.

Instead, report it privately via [GitHub Security Advisories](https://github.com/0labs-in/vision-link/security/advisories/new).
...
We aim to respond within 7 days and issue a fix within 30 days for confirmed vulnerabilities.
